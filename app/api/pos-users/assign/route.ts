...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${credentials.baseUrl}/api/method/dukaplus.services.rest.assign_pos_user_store`, {
      method: "POST",
      headers: {
    ...
    console.error("Error assigning POS user to store:", error)
