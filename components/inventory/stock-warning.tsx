  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <p className={isOutOfStock ? "text-red-200 font-medium" : "text-yellow-200 font-medium"}>{product.name}</p>
        <p className={isOutOfStock ? "text-red-100/70 text-sm" : "text-yellow-100/70 text-sm"}>
          {isOutOfStock
